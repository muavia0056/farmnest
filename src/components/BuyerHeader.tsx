...
const BuyerHeader = ({ title, navigation, rightComponent, notifCount }: BuyerHeaderProps) => (
  <>
...
const styles = StyleSheet.create({
  ...
  titleUnderline: { height: 3, width: 30, backgroundColor: '#1565C0', borderRadius: 2, marginTop: 3 },
